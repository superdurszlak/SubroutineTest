...
from src.materials_handler import MaterialsHandler
from src.simulation_type_handler import SimulationTypeHandler
...
class GuiMainWindow:
    ...
    def __init__(self):
        ...
        self.materials_frame = Frame(self.master, width=side_frames_width, height=side_frames_height,
                                     borderwidth=config.FRAME_BORDER_WIDTH, relief=config.FRAME_RELIEF)
        self.materials_frame.grid(row=0, column=1, padx=config.FRAME_PADDING, pady=config.FRAME_PADDING)
